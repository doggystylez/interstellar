...
func TxCmd() (txCmd *cobra.Command) {
	...
	cmds := flags.AddFlags([]*cobra.Command{sendCmd(), sendAllCmd(), transferCmd(), transferAllCmd(), swapCmd()}, flags.TxFlags, flags.KeyFlags, flags.QueryFlags, flags.GlobalFlags)
